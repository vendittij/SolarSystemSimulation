...
public class PlanetTestMain {
    ...
    public static void main(String[] args) {
        ...
        System.out.printf("Planet Radius: %f\n", earth.getPlanetRaidus());
        System.out.printf("Semi-Major Axis: %f\n", earth.getSemiMajorAxis());
        earth.setPosition(new Point2D.Double(-earth.getPeriapsisDistanceFromSun() * 100, 12));
        ...
        System.out.printf("Mass: %f\n", mars.getMass());
        System.out.printf("Period: %f\n", mars.getPeriod());
        System.out.printf("Planet Radius: %f\n", mars.getPlanetRaidus());
        System.out.printf("Semi-Major Axis: %f\n\n", mars.getSemiMajorAxis());
        mars.setPosition(new Point2D.Double(-mars.getPeriapsisDistanceFromSun(), 12));
